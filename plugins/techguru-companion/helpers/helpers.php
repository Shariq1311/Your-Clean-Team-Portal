...
if (!function_exists('Mojar_helper_filter_posts')) {
    /**
     ...
     * @return array
     */
    function Mojar_helper_filter_posts(array $criteria): array
    {
...
if (!function_exists('Mojar_format_text')) {
    /**
     ...
     * @return string
     */
    function Mojar_format_text($text): string
    {
