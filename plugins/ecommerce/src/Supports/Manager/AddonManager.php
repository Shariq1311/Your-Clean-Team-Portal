...
class AddonManager
{
    ...
    protected function initAddon($addon)
    {
        ...
        //    e.g. "MojarCMS\Ecommerce\Addons\POSAddonServiceProvider"
    ...
    protected function resolveAddonProvider(string $slug): string
    {
        ...
        // e.g. "pos-addon" => "MojarCMS\Ecommerce\Addons\PosAddonServiceProvider"
        $slugStudly = str_replace('-', '', ucwords($slug, '-'));
        return "MojarCMS\\Ecommerce\\Addons\\{$slugStudly}\\{$slugStudly}ServiceProvider";
    }
}
