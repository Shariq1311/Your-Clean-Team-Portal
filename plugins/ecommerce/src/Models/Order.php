...
use MojarCMS\CMS\Traits\UseMetaData;
use MojarCMS\Backend\Models\Post;

/**
 * MojarCMS\Ecommerce\Models\Order
 *
 * @property int $id
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \MojarCMS\Ecommerce\Models\OrderItem> $orderItems
 * @property-read int|null $order_items_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \MojarCMS\Ecommerce\Models\Product> $products
