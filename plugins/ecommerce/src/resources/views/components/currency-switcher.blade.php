@php
    $currencies = ecom_get_available_currencies();
    $currentCurrency = ecom_get_current_currency_code();
@endphp

@if(get_config('ecomm_enable_multi_currency', false) && get_config('ecomm_allow_currency_switcher', true) && count($currencies) > 1)
