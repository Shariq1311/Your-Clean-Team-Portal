...
{{ Field::text(
    trans('ecomm::content.paystack_test_public_key'),
...
{{ Field::text(
    trans('ecomm::content.paystack_test_secret_key'),
...
{{ Field::text(
    trans('ecomm::content.paystack_live_public_key'),
...
{{ Field::text(
    trans('ecomm::content.paystack_live_secret_key'),
