...
@section('content')
            ...
            <div class="col-md-8">
                ...
                <div class="form-group">
                    @component('cms::components.card', [
                        ...
                        @foreach (['paypal', 'custom', 'stripe', 'razorpay', 'mollie', 'bank_transfer', 'cod', 'flutterwave', 'paystack', 'instamojo', 'paymongo', 'twocheckout'] as $type)
                            @if ($model->type == $type)
    ...
    @foreach(['paypal', 'stripe', 'razorpay', 'mollie', 'bank_transfer', 'cod', 'flutterwave', 'paystack', 'instamojo', 'paymongo', 'twocheckout'] as $type)
