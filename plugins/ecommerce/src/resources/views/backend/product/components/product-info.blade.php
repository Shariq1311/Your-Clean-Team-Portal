@php
    /**
     * @var \MojarCMS\Backend\Models\Post $model
     * @var \MojarCMS\merce\Models\ProductVariant $variant
     */
...
<div class="card mt-3 mb-3">
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs">
            ...
            <li class="nav-item">
                <a href="#tabs-additional-info-area" class="nav-link" data-bs-toggle="tab">
    ...
    <div class="card-body">
        <div class="tab-content">
                ...
                <div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            {{ Field::select(trans('ecomm::content.badge'), 'meta[badge]', [
                                'value' => $model->getMeta('badge') ?? '',
                                'options' => array_merge(
                                    ['' => '--- ' . trans('ecomm::content.select_badge') . ' ---'],
                                    [
                                        'new' => 'New',
                                        'sale' => 'Sale',
                                        'hot' => 'Hot',
            ...
            <div class="tab-pane" id="tabs-additional-info-area">
                <div>
                    {{ Field::textarea(trans('ecomm::content.additional_information'), 'meta[additional_information]', [
                        'value' => $model->getMeta('additional_information') ?? '',
                    ]) }}

                    {{ Field::textarea(trans('ecomm::content.short_description'), 'meta[short_description]', [
                        'value' => $model->getMeta('short_description') ?? '',
                    ]) }}
                </div>
            </div>
