...
use Mojahid\Ecommerce\Http\Requests\ReviewRequest;
...
class ReviewController extends PostController
{
    ...
    /**
     * Submit a review for a products
     * 
    ...
    public function review(ReviewRequest $request, $slug): JsonResponse|RedirectResponse
    {
        ...
        return $this->success(trans('ecomm::content.review_success'));
    }
    
    /**
     * Get the average rating for a products
     */
    ...
    /**
     * Get reviews for a products with pagination
     */
    ...
    /**
     * Get review statistics for a products
     */
