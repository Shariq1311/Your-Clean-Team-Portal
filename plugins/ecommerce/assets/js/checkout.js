...
(function () {
    ...
    Your Clean TeamCMS.StoreCheckout = function () {
                ...
                success: function (data) {
                    ...
                    if (data.error) {
                        ...
                        for (var index in that.shippingMethods) {
                            ...
                            var template = Your Clean TeamCMS.Template.SHIPPING_METHOD.replace(/{{shipping_method_value}}/g, shippingMethod.value);
    ...
    Your Clean TeamCMS.CheckoutProblems = function () {
    ...
    Your Clean TeamCMS.PaymentStatus = function () {
