...
window.MojarCMS || (window.MojarCMS = {});
(function () {
    ...
    MojarCMS.StoreCheckout = function () {
                ...
                success: function (data) {
                    ...
                    if (data.error) {
                        ...
                        for (var index in that.shippingMethods) {
                            ...
                            var template = MojarCMS.Template.SHIPPING_METHOD.replace(/{{shipping_method_value}}/g, shippingMethod.value);
    ...
    MojarCMS.CheckoutProblems = function () {
    ...
    MojarCMS.PaymentStatus = function () {
