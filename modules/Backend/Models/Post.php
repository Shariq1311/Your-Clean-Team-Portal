...
use MojarCMS\CMS\Database\Factories\PostFactory;
use MojarCMS\CMS\Models\Model;
use MojarCMS\CMS\Traits\PostTypeModel;
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\MojarCMS\Backend\Models\Comment[] $comments
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\MojarCMS\Backend\Models\PostMeta[] $metas
 * @property-read int|null $metas_count
 * @property-read \Illuminate\Database\Eloquent\Collection|\MojarCMS\Backend\Models\PostRating[] $ratings
 * @property-read int|null $post_ratings_count
 * @property-read \Illuminate\Database\Eloquent\Collection|\MojarCMS\Backend\Models\PostView[] $postViews
 * @property-read int|null $post_views_count
 * @property-read \Illuminate\Database\Eloquent\Collection|\MojarCMS\Backend\Models\Taxonomy[] $taxonomies
 * @property-read int|null $taxonomies_count
 * @property-read \MojarCMS\CMS\Models\User|null $updatedBy
 * @method static \MojarCMS\CMS\Database\Factories\PostFactory factory(...$parameters)
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\MojarCMS\Backend\Models\Taxonomy[] $categories
 * @property-read int|null $categories_count
 * @property-read \Illuminate\Database\Eloquent\Collection|\MojarCMS\Backend\Models\Taxonomy[] $tags
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\MojarCMS\Backend\Models\PostLike[] $likes
 * @property-read int|null $likes_count
 * @property-read int|null $ratings_count
 * @property-read \Illuminate\Database\Eloquent\Collection|\MojarCMS\Backend\Models\Resource[] $resources
