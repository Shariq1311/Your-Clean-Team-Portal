...
$(document).ready(function () {
    ...
    function showNotification(response) {
        if (
            typeof mojarcms !== "undefined" &&
            typeof mojarcms.message !== "undefined"
        ) {
            // Use MojarCMS's built-in notification system
            mojarcms.message(response.data);
        } else {
            CustomToast.show({
...
class MojarTable {
    ...
    constructor(e) {
        ...
        this.form_search = (e.form_search) ? mojarcmse.form_search : "#form-search";
...
$(document).ready(function () {
    ...
    if (typeof window.chooseMedia !== 'function' && typeof mojarcms !== 'undefined' && typeof mojarcms.media !== 'undefined') {
