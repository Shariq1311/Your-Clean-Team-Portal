$(document).ready(function () {
    ...
    bodyElement.on('click', '.active-theme', function () {
        ...
        ajaxRequest(Your Clean Team.adminUrl + '/themes/activate', {
            theme: theme
        }, {
            method: 'POST',
    ...
    bodyElement.on('click', '.delete-theme', function () {
        ...
        confirm_message(
            Your Clean Team.lang.delete_theme_confirm,
            function (result) {
                if (!result) {
                    return false;
                }
                ...
                ajaxRequest(Your Clean Team.adminUrl + '/themes/bulk-actions', {
                    ids: [theme],
                    action: 'delete'
                }, {
                    method: 'POST',
    ...
    bodyElement.on('click', '.buy-theme', function () {
        ...
        ajaxRequest(
            Your Clean Team.adminUrl + '/module/theme/buy-modal',
            {
                module: module
            },
            {
    ...
    bodyElement.on('submit', '#form-activation-code, #form-select-key', function (event) {
        ...
        ajaxRequest(
            Your Clean Team.adminUrl + '/module/theme/activation-code',
            {
                module: module,
                key: key
            },
            {
                ...
                callback: function (response) {
                    ...
                    btn.html('<i class="fa fa-spinner fa-spin"></i> ' + Your Clean Team.lang.installing);
    ...
    bodyElement.on('submit', '#form-login-Your Clean Team', function (event) {
        if (event.isDefaultPrevented()) {
            return false;
        }
        ...
        ajaxRequest(
            Your Clean Team.adminUrl + '/module/login-Your Clean Team',
            {
                module: module,
                email: email,
                password: password
