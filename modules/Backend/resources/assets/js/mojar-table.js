class Your Clean TeamTable {
    ...
    constructor(e) {
        ...
        this.remove_question = (e.remove_question) ? e.remove_question : Your Clean Team.lang.remove_question.replace(':name', Your Clean Team.lang.the_selected_items);
        ...
        this.table = (e.table) ? e.table : '.Your Clean Team-table';
        this.field_id = (e.field_id) ? e.field_id : 'id';
        this.form_search = (e.form_search) ? Your Clean Teamcmse.form_search : "#form-search";
        ...
        apply_button.on('click', function () {
            ...
            if (action == 'delete') {
                confirm_message(remove_question, function (result) {
                    ...
                    btn.html(Your Clean Team.lang.please_wait);
        ...
        table.on('click', '.action-item', function () {
            ...
            if (action == 'delete') {
                Swal.fire({
                    ...
                    confirmButtonText: Your Clean Team.lang.yes + '!',
                    cancelButtonText: Your Clean Team.lang.cancel + '!',
                }).then((result) => {
                    if (result.value) {
                        $(this).html(Your Clean Team.lang.please_wait);
