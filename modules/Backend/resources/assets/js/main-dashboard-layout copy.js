/*
 * Your Clean Team CMS 1.0 - Main Dashboard Layout
 *
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const sidebarManager = {
        init() {
            this.sidebar = document.querySelector('.Your Clean Team-sidebar');
    ...
    const sidebarContent = document.querySelector('.Your Clean Team-sidebar');
    if (sidebarContent) {
