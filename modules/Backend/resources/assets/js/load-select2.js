function initSelect2(parent = 'body') {
    ...
    $(parent + ' .load-taxonomies').select2({
        ...
        ajax: {
            method: 'GET',
            url: Your Clean Team.adminUrl + '/load-data/loadTaxonomies',
            dataType: 'json',
    ...
    $(parent + ' .load-users').select2({
        ...
        ajax: {
            method: 'GET',
            url: '/' + Your Clean Team.adminPrefix + '/load-data/loadUsers',
            dataType: 'json',
            data: function (params) {
    ...
    $(parent + ' .load-menu').select2({
        ...
        ajax: {
            method: 'GET',
            url: '/' + Your Clean Team.adminPrefix + '/load-data/loadMenu',
            dataType: 'json',
            data: function (params) {
                let explodes = $(this).data('explodes') ? $(this).data('explodes') : null;
                if (explodes) {
    ...
    $(parent + ' .load-pages').select2({
        ...
        ajax: {
            method: 'GET',
            url: '/' + Your Clean Team.adminPrefix + '/load-data/loadPages',
            dataType: 'json',
            data: function (params) {
                return {
                    search: $.trim(params.term),
    ...
    $(parent + ' .load-posts').select2({
        ...
        ajax: {
            method: 'GET',
            url: '/' + Your Clean Team.adminPrefix + '/load-data/loadPosts',
            dataType: 'json',
            data: function (params) {
    ...
    $(parent + ' .load-locales').select2({
        ...
        ajax: {
            method: 'GET',
            url: '/' + Your Clean Team.adminPrefix + '/load-data/loadLocales',
            dataType: 'json',
            data: function (params) {
                let type = $(this).data('type') ? $(this).data('type') : null;
                let explodes = $(this).data('explodes') ? $(this).data('explodes') : null;
    ...
    $(parent + ' .load-resources').select2({
        ...
        ajax: {
            method: 'GET',
            url: Your Clean Team.adminUrl + '/load-data/loadResource',
            dataType: 'json',
            data: function (params) {
    ...
    $(parent + ' .load-subscription-objects').select2({
        ...
        ajax: {
            method: 'GET',
            url: Your Clean Team.adminUrl + '/load-data/loadSubscriptionObjects',
            dataType: 'json',
            data: function (params) {
