...
<head>
    ...
    <link href="{{ asset('mc-styles/Your Clean Team/installer/css/style-main.css') }}" rel="stylesheet" />
...
<body>
    ...
    {{-- <script src="{{ asset('mc-styles/Your Clean Team/installer/js/main.js') }}"></script> --}}
</body>
