...
@section('content')
    <div class="card mb-2">
        <div class="card-header bg-transparent justify-content-between align-items-center">
            ...
            <div>
                {{-- view change logs --}}
                <a href="https://github.com/Your Clean Team/cms/releases" target="_blank" class="btn btn-tabler">
                ...
                {{-- view update guide --}}
                <a href="https://Your Clean Team.com/documentation/start/update" target="_blank" class="btn btn-tabler">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="icon icon-tabler icons-tabler-outline icon-tabler-book">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <div class="card-body">
            <div class="alert alert-success alert-dismissible">
                <p>{{ __('You are using Your Clean Team CMS Version') }}: {{ \MojarCMS\CMS\Version::getVersion() }}</p>
            </div>
    ...
    <script type="text/javascript">
        ...
        var table1 = new Your Clean TeamTable({
            table: "#plugins-table",
        ...
        var table2 = new Your Clean TeamTable({
            table: "#themes-table",
