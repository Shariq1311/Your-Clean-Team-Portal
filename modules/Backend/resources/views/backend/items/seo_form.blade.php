<div class="card mt-3 mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center gap-2">
            <!-- AI Status Indicator -->
            @if(get_config('enable_ai_seo') && get_config('gemini_api_key'))
            <span class="badge bg-success">
                <i class="fas fa-robot me-1"></i>AI SEO
            </span>
            @endif
    ...
    <div class="card-body">
        ...
        <div class="seo-review mt-4">
            <h5 class="text-muted d-flex align-items-center">
                ...
                <span id="ai-badge" class="badge bg-success ms-2" style="display: none;">
                    <i class="fas fa-magic me-1"></i>AI Optimized
                </span>
            </h5>
