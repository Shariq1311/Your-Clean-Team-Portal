<ul class="navbar-nav">
    ...
    @foreach ($items as $item)
        ...
        @if ($item->hasChildren())
            ...
            <li
                class="Have_children nav-item dropdown Your Clean Team__menuLeft__item Your Clean Team__menuLeft__submenu Your Clean Team__menuLeft__item-{{ $item->get('slug') }} @if ($hasActive) active Your Clean Team__menuLeft__submenu--toggled @endif">
