            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        {{ Field::image(trans('cms::app.different_auth_logo'), 'different_auth_logo', [
                            'value' => get_config('different_auth_logo'),
                        ]) }}
                        <p class="description mt-2">{{ trans('cms::app.different_auth_logo_description') }}</p>
                    </div>
                </div>

                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        {{ Field::image(trans('cms::app.cover'), 'cover', [
                            'value' => get_config('cover'),
                        ]) }}
                        <p class="description mt-2">{{ trans('cms::app.cover_description') }}</p>
                    </div>
                </div>

                <div class="auth-setting col-md-6 mb-3">
                    <div class="form-group">
