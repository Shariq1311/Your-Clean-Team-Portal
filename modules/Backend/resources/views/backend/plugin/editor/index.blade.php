...
@section('header')
    <link rel="stylesheet" href="{{ asset('mc-styles/Your Clean Team/css/code-editor.min.css') }}" />
    <script>
        ...
        const monacoFolder = "{{ asset('mc-styles/Your Clean Team/monaco-editor/min/vs') }}";
        let file = "{{ $file }}";
    </script>
    <script src="{{ asset('mc-styles/Your Clean Team/js/plugin-editor.min.js') }}"></script>
@endsection
