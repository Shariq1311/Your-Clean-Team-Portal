...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive mb-5">
                <table class="table Your Clean Team-table">
                    <thead>
                        <tr>
    ...
    <script type="text/javascript">
        function status_formatter(value, row, index) {
            switch (value) {
                case 'installed':
                    return `<span class="text-success">${Your Clean Team.lang.installed}</span>`;
            }

            return `<span class="text-secondary">${Your Clean Team.lang.not_installed}</span>`;
        }
