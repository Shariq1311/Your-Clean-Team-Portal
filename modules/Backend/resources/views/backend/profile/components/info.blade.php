    ...
    <div class="row g-3">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        {{ Field::text('birthday', 'metas[birthday]', [
                            'value' => $mc_user->getMeta('birthday'),
        ...
        <div class="col-md-4">
            <div class="form-group mb-3">
                {{ Field::image($mc_user, 'avatar', [
                    'class' => 'profile-avatar-upload'
                ]) }}
            </div>

            <div class="form-group">
                {{ Field::select($mc_user, 'language', [
                    'options' => $languages,
                    'class' => 'form-select'
                ]) }}
            </div>
