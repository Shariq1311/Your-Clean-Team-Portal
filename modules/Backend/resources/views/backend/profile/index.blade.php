            ...
            <div class="card card-profile">
                <div class="card-body text-center">
                    <div class="profile-image mb-3">
                        <span class="avatar avatar-xl rounded-circle" style="background-image: url('{{ $mc_user->getAvatar() }}')"></span>
                    ...
                    <h3 class="mb-1">{{ $mc_user->name }}</h3>
                    <p class="text-muted mb-0">
                        {{ $mc_user->is_admin ? 'Administrator' : 'User' }}
                    </p>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="profile-info-item">
                        ...
                        <div class="profile-info-content">
                            ...
                            <span class="profile-info-value">{{ $mc_user->name }}</span>
                        </div>
                    </div>
                    ...
                    <div class="profile-info-item">
                        ...
                        <div class="profile-info-content">
                            ...
                            <span class="profile-info-value">{{ $mc_user->email }}</span>
                        </div>
                    </div>
                    ...
                    <div class="profile-info-item">
                        ...
                        <div class="profile-info-content">
                            ...
                            <span class="profile-info-value">{{ $mc_user->getMeta('birthday') ?? '—' }}</span>
                        </div>
                    </div>
                </div>
            </div>
