        ...
        <div class="col-xl-3 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-wrap flex-column align-items-center">
                        <div class="Your Clean Team__utils__avatar Your Clean Team__utils__avatar--size64 mb-3">
                            <img src="{{ $mc_user->getAvatar() }}" alt="Mary Stanform">
                        </div>
                        <div class="text-center">
                            <div class="text-dark font-weight-bold font-size-18">{{ $mc_user->name }}</div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">{{ $mc_user->name }}</p>

                    <hr>
                    <strong>
                        <i class="fa fa-envelope mr-1"></i> {{ trans('cms::profile.email') }}
                    </strong>
                    <p class="text-muted">{{ $mc_user->email }}</p>
