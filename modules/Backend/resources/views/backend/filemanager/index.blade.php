...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('mc-styles/Your Clean Team/images/favicon.ico') }}">
    {{-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.css"> --}}

    <link rel="stylesheet" href="{{ asset('mc-styles/Your Clean Team/css/filemanager.min.css') }}">
    <link rel="stylesheet" href="{{ asset('mc-styles/Your Clean Team/css/vendor.min.css') }}">
    <link rel="stylesheet" href="{{ asset('mc-styles/Your Clean Team/assets/css/tabler.min.css') }}">
...
<body class="Your Clean Team-cms-filemanager">
    ...
    <script src="{{ asset('mc-styles/Your Clean Team/js/filemanager.min.js') }}?v={{ \MojarCMS\CMS\Version::getVersion() }}">
    </script>
    <script src="{{ asset('mc-styles/Your Clean Team/js/vendor.min.js') }}"></script>
    <script src="{{ asset('mc-styles/Your Clean Team/assets/js/tabler.min.js') }}"></script>
        ...
        function refreshMediaList() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    const newContent = doc.querySelector('.mc-media-list');
                    if (newContent) {
                        document.querySelector('.mc-media-list').innerHTML = newContent.innerHTML;
                    }
                },
                error: function() {
