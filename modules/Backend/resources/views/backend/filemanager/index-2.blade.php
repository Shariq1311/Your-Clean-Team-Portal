...
<body class="Your Clean Team-cms-filemanager">
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark Your Clean Team-cms-filemanager-navbar" id="nav">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            @if (config('Your Clean Team.filemanager.upload_from_url'))
                                <li class="nav-item">
    ...
    <script src="{{ asset('mc-styles/Your Clean Team/js/filemanager.min.js') }}?v={{ \MojarCMS\CMS\Version::getVersion() }}"></script>
