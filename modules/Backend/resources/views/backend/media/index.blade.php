...
<div class="card" id="media-container">
    ...
    <div class="card-body">
        <div class="row">
            {{-- Media List Section --}}
            <div class="col-md-9">
                <div class="mc-list-media">
                    <ul class="mc-media-list">
            ...
            {{-- Preview Panel --}}
            <div class="col-md-3">
                <div id="preview-file" class="mc-preview-file">
...
@section('footer')
    ...
    <template id="media-detail-template">
        <div class="mc-file-box-image mb-3">
            <img src="{url}" alt="" class="mc-preview-image">
        </div>
