...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('mc-styles/Your Clean Team/images/favicon.ico') }}">
    <link rel="stylesheet" href="{{ asset('mc-styles/Your Clean Team/css/theme-editor.css') }}">
    <!--[if lt IE 9]>
    <script src="{{ asset('mc-styles/Your Clean Team/js/html5shiv.min.js') }}"></script>
    <script src="{{ asset('mc-styles/Your Clean Team/js/respond.min.js') }}"></script>
    <![endif]-->

    <script src="{{ asset('mc-styles/Your Clean Team/js/theme-editor.js') }}"></script>
    ...
    {{-- <script type="text/javascript">
        $(document).ajaxStart(function () {
            Your Clean Team.Loading.start();
        });
        $(document).ajaxComplete(function () {
            Your Clean Team.Loading.stop();
        });

        setInterval(function () {
            Your Clean Team.CSRFToken.update();
        }, 3600000);
    </script> --}}
</head>
...
<body class="body-theme-editor theme-editor sfe-next fresh-ui next-ui" id="theme-editor"
    ...
    <main class="theme-editor__wrapper" component="UI.Progress"
        define="{editorThemeV2: new Your Clean Team.ThemeSettingsV2(this,{&quot;current_section&quot;:-1,&quot;id&quot;:731236})}"
        content="editorThemeV2">
        <div class="notifications">
            <div class="ajax-notification">
                <span class="ajax-notification-message"></span>
                <a class="close-notification" onclick="Your Clean Team.Flash.hide()"><i class="fa fa-times"></i></a>
            </div>
        </div>

        {{-- <script type="text/javascript">
        Page(function () {
            $(document).on("click", Your Clean Team.SingleDropdown.checkFocus);
            document.addEventListener('page:before-replace', function () {
                $(document).off("click", Your Clean Team.SingleDropdown.checkFocus);
            }, { once: true });
        });
    </script> --}}
