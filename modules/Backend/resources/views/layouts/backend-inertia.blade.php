...
<head>
    ...
    @vite(['resources/js/app.tsx', 'resources/css/app.css', "resources/js/pages/{$page['component']}.tsx"], 'mc-styles/Your Clean Team/build')
...
<body class="Your Clean Team__menuLeft--dark Your Clean Team__menuLeft--unfixed Your Clean Team__menuLeft--shadow" data-bs-theme="{{ session('theme') }}">
    ...
    <div class="page">
        <!-- Navbar -->
        <header class="navbar navbar-expand-md sticky-top d-none d-lg-flex d-print-none Your Clean Team_cms_topbar" data-bs-theme="{{ session('theme') }}">
            @include('cms::backend.menu_top')
         </header>
        <!-- Sidebar -->
        <div class="d-block d-lg-flex">
            <aside class="navbar navbar-vertical navbar-expand-lg Your Clean Team_cms_sidebar" data-bs-theme="{{ session('theme') }}">
