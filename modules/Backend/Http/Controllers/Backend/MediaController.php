...
use MojarCMS\Backend\Events\AddFolderSuccess;
use MojarCMS\Backend\Http\Requests\Media\AddFolderRequest;
use MojarCMS\Backend\Http\Requests\Media\UpdateRequest;
...
class MediaController extends BackendController
{
    ...
    protected function getFiles(Collection $sQuery, int $limit = 40, ?int $folderId = null): LengthAwarePaginator
    {
        ...
        // Apply user restriction for files if not admin
    ...
    protected function getDirectories(Collection $sQuery, ?int $folderId): \Illuminate\Database\Eloquent\Collection
    {
        ...
        // Note: MediaFolder doesn't have user_id, so all users can see all folders
        // Only files are filtered by user ownership
