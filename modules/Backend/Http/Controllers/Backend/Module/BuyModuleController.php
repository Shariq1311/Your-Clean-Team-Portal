...
namespace MojarCMS\Backend\Http\Controllers\Backend\Module;

use Illuminate\Http\JsonResponse;
use Illuminate\Http\RedirectResponse;
use Illuminate\Http\Request;
use Illuminate\Support\Str;
use MojarCMS\Backend\Http\Requests\Module\ActivateByCodeRequest;
use MojarCMS\Backend\Http\Requests\Module\LoginMojarCMSRequest;
use MojarCMS\CMS\Contracts\MojarApiContract as MojarApi;
...
class BuyModuleController extends BackendController
{
    ...
    public function loginMojar(LoginMojarCMSRequest $request): JsonResponse|RedirectResponse
    {
