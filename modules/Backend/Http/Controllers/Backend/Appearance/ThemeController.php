...
class ThemeController extends BackendController
{
    ...
    public function index(): View|Response
    {
        ...
        if (!$mc_user->can('themes.index')) {
            abort(403);
        }

        $activated = mc_current_theme();
    ...
    protected function addRequireThemeActive(\MojarCMS\CMS\Support\Theme $theme): void
    {
