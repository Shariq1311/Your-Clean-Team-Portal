...
use MojarCMS\CMS\Support\Theme\CustomMenuBox;
use MojarCMS\CMS\Support\Updater\CmsUpdater;
use MojarCMS\CMS\Version;
use MojarCMS\Frontend\Http\Controllers\PageController;
...
class MenuAction extends Action
{
    ...
    public function addBackendMenu(): void
    {
        ...
        // users
        HookAction::addAdminMenu(
            trans('cms::app.managements-area.users'),
            'users',
            [
        ...
        HookAction::addAdminMenu(
            trans('cms::app.managements-area.roles'),
            'roles',
            [
    ...
    {
        $templates = ThemeLoader::getTemplates(mc_current_theme());
        $data = [
    ...
    public function addAdminScripts(): void
    {
        ...
        HookAction::enqueueScript('core-vendor', 'mc-styles/Mojar/js/vendor.min.js', $ver);
        HookAction::enqueueScript('core-backend', 'mc-styles/Mojar/js/backend.min.js', $ver);
        HookAction::enqueueScript('core-tinymce', 'mc-styles/Mojar/tinymce/tinymce.min.js', $ver);
        HookAction::enqueueScript('core-custom', 'mc-styles/Mojar/js/custom.min.js', $ver);
        HookAction::enqueueScript('custom-main-js', 'mc-styles/Mojar/js/custom-main.min.js', $ver);
        // Tabler js
        HookAction::enqueueScript('tabler-apexcharts', 'mc-styles/Mojar/assets/libs/apexcharts/dist/apexcharts.min.js', $ver);
        HookAction::enqueueScript('tabler-jsvectormap', 'mc-styles/Mojar/assets/libs/jsvectormap/dist/js/jsvectormap.min.js', $ver);
        HookAction::enqueueScript('tabler-jsvectormap-maps', 'mc-styles/Mojar/assets/libs/jsvectormap/dist/maps/world.js', $ver);
        HookAction::enqueueScript('tabler-jsvectormap-world', 'mc-styles/Mojar/assets/libs/jsvectormap/dist/maps/world-merc.js?1692870487', $ver);
        HookAction::enqueueScript('tabler-main-js', 'mc-styles/Mojar/assets/js/tabler.min.js', $ver);
    }

    public function addAdminStyles(): void
    {
        $ver = Version::getVersion();
        HookAction::enqueueStyle('core-vendor', 'mc-styles/Mojar/css/vendor.min.css', $ver);
        // HookAction::enqueueStyle('core-backend', 'mc-styles/Mojar/css/backend.min.css', $ver);
        // HookAction::enqueueStyle('core-custom', 'mc-styles/Mojar/css/custom.min.css', $ver);
        // Tabler css
        HookAction::enqueueStyle('tabler-main', 'mc-styles/Mojar/assets/css/tabler.min.css', $ver);
        HookAction::enqueueStyle('tabler-vendors', 'mc-styles/Mojar/assets/css/tabler-vendors.min.css', $ver);
        HookAction::enqueueStyle('base-custom', 'mc-styles/Mojar/assets/css/custom.css', $ver);
        HookAction::enqueueStyle('base-custom', 'mc-styles/Mojar/css/app.css', $ver);
    }
