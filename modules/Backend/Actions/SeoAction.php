...
use MojarCMS\Backend\Http\Controllers\Backend\Setting\SeoController;
    ...
    public function addMenu()
    {
        $this->hookAction->registerConfig(
            [
                'enable_ai_seo' => [
                    'type' => 'select',
                    'label' => trans('cms::app.seo.enable_ai_seo'),
                    'form' => 'seo',
                    'data' => [
                        'options' => [
                ...
                'gemini_api_key' => [
                    'type' => 'text',
                    'label' => trans('cms::app.seo.gemini_api_key'),
                    'form' => 'seo',
                ],
                'mc_enable_sitemap' => [
                    'form' => 'seo',
