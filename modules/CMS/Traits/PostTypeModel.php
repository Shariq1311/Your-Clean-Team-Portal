...
use MojarCMS\Backend\Models\PostMeta;
use MojarCMS\Backend\Models\Taxonomy;
use MojarCMS\Backend\Support\PostContentParser;
 ...
 * @method Builder whereCreatedBy($userId)
 */
trait PostTypeModel
{
    use ResourceModel;
    ...
    public function scopeWhereFilter($builder, $params = []): Builder
    {
        ...
        // Filter by user role (for vendor)
     ...
     * @return Builder
     */
    public function scopeWhereCreatedBy(Builder $builder, int $userId): Builder
    {
    ...
    public function getUpdatedDate($format = MC_DATE_TIME): string
    {
        return mc_date_format($this->updated_at, $format);
    }

    public function getCreatedDate($format = MC_DATE_TIME): string
    {
        return mc_date_format($this->updated_at, $format);
    }
