...
class PermissionServiceProvider extends ServiceProvider
{
    ...
    protected function registerCommands()
    {
        $this->commands(
            [
                \MojarCMS\CMS\Console\Commands\Permission\CacheReset::class,
                \MojarCMS\CMS\Console\Commands\Permission\CreateRole::class,
                \MojarCMS\CMS\Console\Commands\Permission\CreatePermission::class,
                \MojarCMS\CMS\Console\Commands\Permission\Show::class,
                \MojarCMS\CMS\Console\Commands\Permission\UpgradeForTeams::class,
            ]
        );
    }
