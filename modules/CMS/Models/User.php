...
use MojarCMS\Backend\Models\Notification;
use MojarCMS\Backend\Models\PasswordReset;
use MojarCMS\Backend\Models\SocialToken;
use MojarCMS\CMS\Abstracts\Action;
use MojarCMS\CMS\Database\Factories\UserFactory;
use MojarCMS\CMS\Traits\Permission\HasRoles;
...
use MojarCMS\Network\Traits\RootNetworkModel;
use Laravel\Passport\HasApiTokens;

/**
 * MojarCMS\CMS\Models\User
 *
 * @property int $id
 ...
 * @method static \MojarCMS\CMS\Database\Factories\UserFactory factory(...$parameters)
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\MojarCMS\Backend\Models\Permission[] $permissions
 * @property-read int|null $permissions_count
 * @property-read \Illuminate\Database\Eloquent\Collection|\MojarCMS\Backend\Models\Role[] $roles
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\MojarCMS\CMS\Models\UserMeta[] $metas
...
class User extends Authenticatable
{
    ...
    public static function getAllStatus(): array
    {
        return [
            ...
            User::STATUS_UNCONFIRMED => trans('cms::app.unconfirmed'),
        ];
    }
    ...
    public function getAvatar(string $size = null): string
    {
        ...
        return asset('mc-styles/Mojar/images/avatar.png');
    }
