...
use MojarCMS\CMS\Exceptions\ThemeNotFoundException;
...
class Theme implements ThemeLoaderContract
{
    ...
    {
        return public_path('mc-styles/themes/' . $theme);
    }

    public function assetsUrl($theme, $secure = null): string
    {
        return asset('mc-styles/themes/' . $theme . '/assets', $secure);
    }
    ...
    public function getScreenshot($theme): string
    {
        ...
        return asset('mc-styles/Mojar/images/screenshot.svg');
    }
