...
use MojarCMS\CMS\Interfaces\Theme\ThemeInterface;
...
class Theme implements ThemeInterface, Arrayable
{
    ...
    {
        if (str_starts_with($path, 'mc-styles/')) {
        ...
        return $this->url->asset("mc-styles/themes/{$this->name}/assets/{$path}");
    }
    ...
    public function getScreenshot(): string
    {
        return $this->asset(
            ...
            'mc-styles/Mojar/images/screenshot.svg'
        );
    }
    ...
    {
        return mc_current_theme() == $this->name;
    }

    public function activate(): void
    {
        Cache::pull(cache_prefix('mc_theme_configs'));
