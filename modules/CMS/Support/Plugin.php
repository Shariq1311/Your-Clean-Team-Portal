...
use MojarCMS\CMS\Interfaces\Theme\PluginInterface;
...
class Plugin implements PluginInterface
{
    ...
    //     if (file_exists($path)) {
    //         return $this->url->asset("mc-styles/plugins/{$this->name}/assets/{$path}");
    //     }
    ...
    //     return $this->url->asset('mc-styles/Mojar/images/thumb-default.png');
    // }
