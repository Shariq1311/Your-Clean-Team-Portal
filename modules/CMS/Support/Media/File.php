...
namespace MojarCMS\CMS\Support\Media;

use Illuminate\Contracts\Filesystem\Filesystem;
use Intervention\Image\Facades\Image;
use MojarCMS\CMS\Contracts\Media\Disk as DiskContract;
use MojarCMS\CMS\Interfaces\Media\FileInterface;
...
class File implements FileInterface
{
    ...
    {
        return in_array($this->mimeType(), ['image/jpeg', 'image/png', 'image/gif', 'image/webp', 'image/svg+xml', 'image/svg']);
    }
