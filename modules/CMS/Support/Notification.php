...
use MojarCMS\CMS\Jobs\SendNotification as SendNotificationJob;
use MojarCMS\Backend\Models\ManualNotification;
...
class Notification
{
    ...
    /**
     * @param array|int|\MojarCMS\CMS\Models\User $users
     * @return $this
     */
