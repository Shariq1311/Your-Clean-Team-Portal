...
use MojarCMS\CMS\Exceptions\InvalidAssetPath;
use MojarCMS\CMS\Exceptions\PluginNotFoundException;
...
class LocalPluginRepository implements LocalPluginRepositoryContract, Countable
{
    ...
    {
        return public_path('mc-styles/plugins') . "/{$module}/assets";
    }
    ...
    {
        $url = $this->url->asset("mc-styles/plugins/{$name}/" . $path);
