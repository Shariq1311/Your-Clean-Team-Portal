...
use MojarCMS\CMS\Facades\ThemeConfig;
use MojarCMS\CMS\Support\Theme\BackendMenuBuilder;
use MojarCMS\CMS\Support\Theme\MenuBuilder;
use TwigBridge\Facade\Twig;

function body_class($class = ''): string
{
    $class = trim('mc-theme mc-theme-body ' . $class);
...
if (!file_exists('mc_theme_info')) {
     ...
     */
    function mc_theme_info(string $theme = null): Collection|\Noodlehaus\Config|null
    {
        if (empty($theme)) {
            return mc_theme_info(mc_current_theme());
        }
...
if (!function_exists('mc_current_theme')) {
    /**
     * Get current active theme
     *
     * @return string
     */
    function mc_current_theme(): string
    {
...
if (!function_exists('mc_theme_config')) {
    /**
     * Get particular theme all information.
     *
     * @param  string|null  $theme
     * @return Collection
     */
    function mc_theme_config(string $theme = null): Collection
    {
        if (empty($theme)) {
...
if (!function_exists('mc_home_page')) {
    function mc_home_page()
    {
...
if (!function_exists('mc_menu_items')) {
    /**
     ...
     * @return Collection
     */
    function mc_menu_items(Menu $menu): Collection
    {
        return $menu->items()
...
if (!function_exists('mc_page_menu')) {
    function mc_page_menu(?array $args): string
    {
        return trans('cms::app.menu_not_found');
    }
}

if (!function_exists('mc_nav_menu')) {
    function mc_nav_menu(?array $args = [])
    {
        $defaults = [
            'menu' => '',
            'container_before' => '',
            'container_after' => '',
            'fallback_cb' => 'mc_page_menu',
            'theme_location' => '',
...
if (!function_exists('mc_nav_backend_menu')) {
    function mc_nav_backend_menu($args = [])
    {
        $defaults = [
            'menu' => '',
            'container_before' => '',
...
if (!function_exists('get_icon')) {
    function get_icon($default = null): string
    {
        return upload_url(
            get_config('icon'),
            asset($default ?: 'mc-styles/Mojar/images/favicon.ico')
        );
    }
}
...
if (!function_exists('mc_get_sidebar')) {
    function mc_get_sidebar($key): Collection
    {
        return HookAction::getSidebars($key);
    }
}

if (!function_exists('mc_get_widgets_sidebar')) {
    function mc_get_widgets_sidebar($key): Collection
    {
...
if (!function_exists('dynamic_sidebar')) {
    function dynamic_sidebar($key): Factory|ViewContract|string
    {
        ...
        $widgets = mc_get_widgets_sidebar($key);
