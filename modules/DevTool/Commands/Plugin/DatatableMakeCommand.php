...
namespace MojarCMS\DevTool\Commands\Plugin;

use Illuminate\Support\Str;
use MojarCMS\CMS\Support\Config\GenerateConfigReader;
use MojarCMS\CMS\Support\Stub;
use MojarCMS\CMS\Traits\ModuleCommandTrait;
use MojarCMS\DevTool\Abstracts\GeneratorCommand;
...
class DatatableMakeCommand extends GeneratorCommand
{
    ...
    {
        /**
         * @var \MojarCMS\CMS\Support\Plugin $module
         */
    ...
    {
        $stubPath = MC_PACKAGE_PATH . '/stubs/plugin/';
