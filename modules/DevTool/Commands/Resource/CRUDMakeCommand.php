...
namespace MojarCMS\DevTool\Commands\Resource;

use Illuminate\Support\Facades\Schema;
use Illuminate\Support\Str;
use MojarCMS\CMS\Abstracts\Action;
use MojarCMS\DevTool\Abstracts\CRUD\ResourceCommand;
...
class CRUDMakeCommand extends ResourceCommand
{
    ...
    public function handle(): void
    {
        ...
        $content = "Route::mcResource('{$tableName}', {$model}Controller::class);";
